...
struct UserPreferences: Codable, Hashable, Sendable {
    ...
    var heroBackgroundBlur: HeroBackgroundBlur = .medium
    ...
    init(from decoder: Decoder) throws {
        ...
        heroBackgroundBlur = try container.decodeIfPresent(HeroBackgroundBlur.self, forKey: .heroBackgroundBlur) ?? .medium
